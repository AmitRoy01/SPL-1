...
class Driver_class
{
  public:
    ...
    void start ()
    {
        ...
        //cout<<"Input a linear equation ( with single variable )  : "<<endl;
        string inpt;
        getline(cin, inpt, '\n');
...
int main(void)
{
    while(1){
        ...
        cout<<"\t\t*_* 1.LINEAR EQUATION( with N variables)  \n\\n\t\t*_* 2. LINEAR EQUATION SOLVE WITH PROCESS\n\t\t*_* 3.POLYNOMIAL EQUATION ( Nth power ) \n\t\t*_* 4. POLYNOMIAL EQUATION SOLVE WITH PROCESS (upto power 2)\n\t\t*_* 5.GRAPH OF LINEAR FUNCTION \n\t\t*_* 6.GRAPH OF POLYNOMIAL EQUATION \n\t\t*_* 7. EXIT\n\n ------->      ";
        cin>>choice;
